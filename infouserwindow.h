...
#ifndef INFOUSERWINDOW_H
#define INFOUSERWINDOW_H
...
namespace Ui {
class InfoUserWindow;
}

class InfoUserWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit InfoUserWindow(QWidget *parent = nullptr);
    ~InfoUserWindow();
protected:
    // on set visible
...
private:
    Ui::InfoUserWindow *ui;

signals:
};

#endif // INFOUSERWINDOW_H
